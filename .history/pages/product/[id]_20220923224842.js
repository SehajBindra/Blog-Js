...
function ProductDetails(product, Products) {
  ...
  return (
    <>
      ...
      <div className="  justify-center  min-h-screen py-2  px-14 text-center bg-gray-100  flex-col w-80 flex align-middle rounded-lg items-center">
        <img
          className="rounded-xl w-80  flex-shrink-0 object-cover "
