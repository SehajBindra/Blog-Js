...
function ProductDetails(product, Products) {
  ...
  return (
    <>
      <Header />
      <div className="justify-center min-h-screen py-8  px-12 text-center bg-white  flex-col  flex align-middle rounded-lg items-center">
        <h2 className="text-2xl text-gray-800 font-semibold   my-5">
          {" "}
