...
function ProductDetails(product, Products) {
  ...
  return (
    <>
      <Header />
      <div className="justify-center flex align-middle text-left">
        <h2 className="text-2xl   my-5"> {product.product.title} </h2>
      </div>
      <div className="justify-center min-h-screen py-8  px-14 text-center bg-white  flex-col  flex align-middle rounded-lg items-center">
        <img
