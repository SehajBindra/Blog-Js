...
function ProductDetails(product, Products) {
  ...
  return (
    <>
      <Header />
      <h2 className="text-3xl flex flex-grow text-gray-900 font-semibold   my-5">
        {" "}
        {product.product.title}{" "}
      </h2>
      <div className=" min-h-screen py-8  px-12 text-center bg-white  flex-col  flex rounded-lg items-center">
        <img
