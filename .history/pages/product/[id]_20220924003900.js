...
function ProductDetails(product) {
  ...
  return (
    <>
      ...
      <div className=" min-h-screen py-8 text-center  px-12  bg-white  flex-col  flex align-middle rounded-lg items-center">
        <div>
          ...
          <div className="flex flex-row space-x-2 my-4 items-center">
            <img
              ...
              alt=""
            />
            <p className="text-2xl flex  font-extralight ">
              {" "}
