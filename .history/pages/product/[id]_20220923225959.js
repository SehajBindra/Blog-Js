...
function ProductDetails(product, Products) {
  ...
  return (
    <>
      <Header />
      <div className="justify-center   min-h-screen py-8  px-14 text-center bg-gray-100  flex-col  flex align-middle rounded-lg items-center">
        <img
        ...
        <div className="my-8">
          ...
          <h2 className="px-8 break-words"> {product.product.desc} </h2>
