...
function ProductDetails(product, Products) {
  ...
  return (
    <>
      <Header />
      <div className=" min-h-screen py-8  px-12 text-left bg-white  flex-col  flex  rounded-lg items-center">
        <h2 className="text-2xl text-left text-gray-900 font-semibold   my-5">
          {" "}
