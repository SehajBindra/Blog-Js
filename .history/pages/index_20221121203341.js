...
export default function Home({ products }) {
  ...
  return (
    <div className="bg-black text-white overflow-y-scroll h-screen  mx-auto">
      ...
      <main className=" sm:grid sm:grid-cols-16 ">
        <Sidebar />

        <div className=" flex flex-row col-span-11  max-h-screen sm:col-span-10 overflow-x-scroll overflow-y-scroll scrollbar-hide">
