...
export default function Home({ products }) {
  ...
  return (
    <div className="bg-black text-white overflow-y-scroll h-screen snap-y snap-mandatory z-0  mx-auto">
      ...
      <div className=" flex flex-col overflow-x-hidden sm:border-x sm:border-gray-800 mx-auto items-center sm:max-w-2xl justify-center pr-10  xl:max-w-[63.4rem] lg:max-w-[42.8rem] md:max-w-[32.1rem]  align-middle   ">
