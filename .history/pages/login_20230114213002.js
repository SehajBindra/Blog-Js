          ...
          {providers &&
            Object.values(providers).map((provider) => (
              <div key={provider.name}>
                <button
                  className="flex flex-row items-center space-x-3   py-3 px-8 bg-transparent rounded-full text-white border border-gray-800 whitespace-nowrap"
                ...
                >
                  <Image
                    ...
                    alt="google logo"
                  />
                  <p className="text-center "> Continue with {provider.name}</p>
                </button>
              </div>
            ))}
        </div>
