  ...
  return (
    <div className="">
      ...
      {properties.map((_property: any) => (
        <div
          className="flex flex-col my-[8rem]  flex-shrink-0  items-center sm:flex-row py-7 px-2 border-b pr-4 rounded-xl cursor-pointer hover:opacity-80 hover:shadow-lg transition duration-200 ease-out first:border-t"
          key={_property._id}
        >
          ...
          <h1 className="mx-8 my-10 text-lg ">{_property.summary}</h1>
