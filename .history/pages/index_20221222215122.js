  ...
  return (
    <>
      ...
      <div className="bg-black text-white overflow-y-scroll h-screen snap-y snap-mandatory z-0  mx-auto">
        ...
        <main className=" sm:grid sm:grid-cols-6 ">
          <Sidebar />

          <div className=" flex flex-row col-span-4  max-h-screen sm:col-span-4 overflow-x-scroll overflow-y-scroll scrollbar-hide">
