...
export default function Home({ products }) {
  ...
  return (
    <div className="bg-white mx-auto  overflow-x-hidden  ">
      <Head>
        <title>Blog</title>
        <link
          rel="icon"
      ...
      <main className=" sm:grid sm:grid-cols-12 ">
        <Sidebar />
        <div className=" flex flex-row col-span-10  max-h-screen sm:col-span-8 overflow-x-scroll scrollbar-hide">
      ...
      <div className=" flex flex-col border-x mx-auto items-center justify-center  max-w-[63.4rem]  align-middle   ">
