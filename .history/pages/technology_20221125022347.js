      ...
      <div className="flex bg-black text-white h-screen flex-col overflow-x-auto overflow-y-auto  scrollbar-hide pb-[8rem]">
        {product.map((product) => (
          <motion.div
            ...
            key={product._id}
            className="flex flex-row justify-center items-center mx-auto bg-black  my-4 "
          >
            <Zoom>
              <div className="flex flex-row flex-shrink-0 items-center  break-before-right  cursor-pointer md:mt-2">
                <Image
                  width={200}
                  height={200}
                  className="image"
                ...
                <h2 className="line-clamp-1 max-w-xs sm:max-w-sm md:max-w-xs  font-semibold text-lg">
                  {" "}
                  {product.title}{" "}
                </h2>
