...
function privacy() {
  return (
    <div className="bg-black h-screen text-white overflow-y-scroll">
      ...
      <div className="max-w-3xl flex flex-col items-center mx-auto px-12 py-10 align-middle text-center justify-center ">
        <div>
          <h1 className="text-3xl underline decoration-sky-500 my-2">
            Privacy Policy
          </h1>
