...
export default function Home({ products }) {
  ...
  return (
    <>
      ...
      <div className="bg-black  overflow-y-scroll h-screen  z-0  mx-auto">
        <Helmet>
          <meta
            name="viewport"
        ...
        <main className=" sm:grid sm:grid-cols-12 ">
          ...
          <div className=" flex flex-row col-span-11  max-h-screen sm:col-span-8 overflow-x-hidden overflow-y-scroll scrollbar-hide">
