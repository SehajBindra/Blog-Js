    ...
    <>
      ...
      <div className="bg-black text-white overflow-y-scroll h-screen snap-y snap-mandatory z-0  mx-auto">
        ...
        <main className=" sm:grid sm:grid-cols-16 ">
          ...
          <div className=" flex flex-row col-span-14  max-h-screen sm:col-span-14 overflow-x-scroll overflow-y-scroll scrollbar-hide">
        ...
        <div className=" flex flex-col overflow-x-hidden  mx-auto items-center  justify-center pr-10   align-middle   ">
