...
function PrivacyPolicy() {
  return (
    <>
      ...
      <div className="bg-black text-white   max-w-3xl  max-w-5xl  max-h-screen overflow-y-scroll scrollbar-hide  ">
        <div className="my-4">
          <p>
          ...
          <p>
            ...
            Policy has been created with the help of the&nbsp; Free Privacy
            Policy Generator .
          </p>
        </div>
        ...
        <ul>
          ...
          <li>
            ...
            "We", "Us" or "Our" in this Agreement) refers to Blog Js, wz-203
          ...
          <li>
            <strong>Website</strong>&nbsp;refers to Blog Js, accessible
            from&nbsp; https://blogjs.tech/
          </li>
          <li>
