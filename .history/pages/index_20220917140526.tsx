  ...
  return (
    <div className="">
      ...
      {properties.map((_property: any) => (
        <div className="flex flex-col   items-center sm:flex-row py-7 px-2 border-b pr-4 rounded-xl  hover:opacity-80 hover:shadow-lg transition duration-200 ease-out first:border-t">
          <div className="relative my-24 cursor-pointer h-32 w-72 md:h-52 md:w-80 flex-shrink-0  sm:my-8">
            <img
