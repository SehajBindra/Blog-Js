  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`The Blog.js Sign In page is a simple, user-friendly and secure way for users to access the website's features. It's fully integrated with Google Authentication, which allows users to sign in to the website using their existing Google account. `}
        />
        <meta
          name="viewport"
