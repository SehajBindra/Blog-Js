  ...
  return (
    <div className="">
      ...
      {products.map((product) => (
        <div
          key={product._id}
          className="flex flex-col  my-24 h-32 w-72 md:h-52 md:w-80 flex-shrink-0  cursor-pointer  items-center sm:flex-row py-7 px-2 border-b pr-4 rounded-xl  hover:opacity-80 hover:shadow-lg transition duration-200 ease-out first:border-t"
        >
          <div className="relative flex-shrink-0  sm:my-8">
