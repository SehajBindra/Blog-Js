...
function PrivacyPolicy() {
  return (
    <div className="bg-black overflow-y-scroll py-4  max-h-screen text-white">
      <Header />
      ...
      <div className="py-4 mx-auto max-w-3xl">
        ...
        <div>
          ...
          "Our" in this Agreement) refers to Blog Js, wz-203 street no-12 new
          Delhi -110058.
        </div>
        <div>
          {" "}
          ...
          refers to: Delhi, India Device means any device that can access the
        ...
        <div>
          ...
          to use the Service. Usage Data refers to data collected automatically,
          either generated by the use of the Service or from the Service
          infrastructure itself (for example, the duration of a page visit).
          Website refers to Blog Js, accessible from https://blogjs.tech/ You
          ...
          or using the Service, as applicable. Collecting and Using Your
          Personal Data Types of Data Collected Personal Data While using Our
          ...
          to: Email address First name and last name Usage Data Usage Data Usage
        ...
        <div>
          ...
          Service may use Cookies. Web Beacons. Certain sections of our Service
          ...
          about cookies on the Free Privacy Policy website article. We use both
        ...
        <div>
          ...
          government agency). Children's Privacy Our Service does not address
