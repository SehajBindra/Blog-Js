...
export default function Home({ products }) {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `http://localhost:3000/api/products/?skip=${skip + 10}`
        );
  ...
  return (
    <div className="bg-black text-white overflow-y-scroll h-screen min-h-[30%]  mx-auto">
      <Head>
      ...
      <div
        ...
        className=" flex flex-col overflow-x-hidden sm:border-x sm:border-gray-800 mx-auto items-center justify-center pr-10  max-w-[63.4rem]  align-middle   "
      >
