  ...
  return (
    <div className="bg-black text-white overflow-y-scroll h-screen  mx-auto">
      ...
      <main className=" sm:grid sm:grid-cols-12 ">
        <Sidebar />
        <div className=" flex flex-row col-span-11  max-h-screen sm:col-span-8 overflow-x-scroll overflow-y-scroll scrollbar-thin  scrollbar-thumb-gray-700 scrollbar-thumb-rounded-lg">
