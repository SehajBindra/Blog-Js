  ...
  return (
    <div className="bg-black overflow-y-scroll  max-h-screen text-white">
      ...
      <div>
        ...
        Delhi, India Device means any device that can access the Service such as
        ...
        a page visit). Website refers to Blog Js, accessible from
        ...
        Social Media Service's account, such as Your name, Your email address,
