  ...
  const fetchData = async () => {
    try {
      const request = await fetch(
        `http://localhost:3000/products?skip=${skip}`
      );
    ...
    <div className="bg-black text-white overflow-y-scroll h-screen  mx-auto">
      ...
      <main className=" sm:grid sm:grid-cols-12 ">
        ...
        <div
          ...
          className=" flex flex-row col-span-11  max-h-screen sm:col-span-8 overflow-x-scroll overflow-y-scroll scrollbar-hide"
        >
