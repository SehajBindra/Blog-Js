  ...
  return (
    <div className="">
      ...
      {properties.map((_property: any) => (
        <div className="flex flex-col my-16   items-center sm:flex-row py-7 px-2 border-b pr-4 rounded-xl cursor-pointer hover:opacity-80 hover:shadow-lg transition duration-200 ease-out first:border-t">
          ...
          <div className="flex flex-col flex-grow mt-2 pl-5">
            ...
            <p className="pt-2 text-xs text-gray-500 flex-grow line-clamp-2">
              {" "}
