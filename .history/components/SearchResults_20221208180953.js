...
function SearchResults({ searchResults }) {
  ...
  return (
    <div className="shadow-lg bg-black    overflow-y-scroll scrollbar-hide py-2 max-h-32  p-4 text-white flex flex-col justify-center align-middle w-80 mx-auto rounded-md  z-10 fixed top-16">
