...
function Header() {
  ...
  return (
    <div className="top-0 sticky z-50 flex sm:grid sm:grid-cols-4  text-center align-middle  h-20  justify-between bg-black overflow-y-auto    py-4 text-white border-1 ">
      {/* left */}
      ...
      <div className=" flex-grow sm:flex-grow-0 ml-2 pb-10 col-span-2 ">
        <div className=" relative  rounded-md ">
          <form className="flex border-2 border-gray-800   rounded-full px-1 py-2 ml-2 mr-2 shadow-lg items-center  ">
            <input
