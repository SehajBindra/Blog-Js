  ...
  return (
    <div className="mt-1 max-w-xs sm:max-w-xl md:max-w-2xl xl:w-5xl scrollbar-hide overflow-x-hidden sm:overflow-visible    text-white">
      ...
      {updateMode && (
        <div>
          <button
            className="text-lg font-semibold cursor-pointer my-4 mx-auto  justify-items-center  py-2 px-12 flex flex-col  align-middle rounded-lg bg-blue-400 text-white"
