...
function Post({ product }) {
  ...
  return (
    <div className="mt-1 max-w-lg tracking-normal leading-relaxed sm:max-w-xl md:max-w-2xl xl:w-5xl scrollbar-hide overflow-x-hidden sm:overflow-visible    text-white">
      {/* header */}
