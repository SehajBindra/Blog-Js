...
function Privacy() {
  return (
    <div>
      <div className="max-w-4xl flex flex-col items-center mx-auto space-y-5  px-12 py-10 align-middle justify-center ">
        <div className="space-y-5 break-all">
          <h1 className="text-3xl text-center underline decoration-sky-500 my-2">
            Privacy Policy
          </h1>

          <h2 className="h2pp ">Interpretation and Definitions</h2>
          <h3 className="h2pp text-lg">Interpretation</h3>
          <p>
          ...
          <h3 className="h2pp text-lg">Definitions</h3>
          ...
          <ul className=" space-y-5">
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Blog Js, B1-Jankpuri New Delhi
                -110058.
              </p>
            </li>
            <li>
          ...
          <h1 className="h2pp">Collecting and Using Your Personal Data</h1>
          <h2 className="h2pp">Types of Data Collected</h2>
          <h3 className="h2pp text-lg decoration-sky-500">Personal Data</h3>
          <p>
          ...
          <ul>
            <li className="h2pp font-semibold decoration-sky-500">
