...
function Footer() {
  ...
  return (
    <div className="grid cursor-pointer gap-x-8 whitespace-nowrap grid-cols-1 md:grid md:grid-cols-3 gap-y-10 mx-auto sm:mx-auto py-14 pb-28 bg-black text-white">
