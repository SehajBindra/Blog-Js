...
function Header() {
  ...
  return (
    <div className="top-0 sticky z-50 flex  h-20  justify-between bg-[#ACE5FF] border-b  py-4 text-gray-800 border-1 ">
      {/* left */}
      ...
      <div className=" flex-grow sm:flex-grow-0 ml-2">
        <div className=" relative  rounded-md ">
          ...
          <input
            className="bg-transparent  w-full pl-12 px-4 py-2 border-2 focus-within:outline-none  placeholder:text-gray-800  rounded-full"
            type="text"
            placeholder="Search"
          />
        </div>
      ...
      <div className=" flex items-center mx-4 cursor-pointer">
        ...
        <div className="flex items-center space-x-2  mx-4 whitespace-nowrap ">
          ...
          <div
            onClick={!session ? signIn : signOut}
            className=" sm:inline  truncate  sm:text-base  text-gray-800"
          >
