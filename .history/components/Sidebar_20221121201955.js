...
function Sidebar() {
  ...
  return (
    <div className="border-r  sticky top-0 z-50 border-gray-800 hidden sm:col-span-2 items-center px-4 md:col-span-2 lg:col-span-2 md:items-start   sm:inline-flex flex-col">
      <img
