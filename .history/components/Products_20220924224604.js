...
function Products({ product }) {
  ...
  return (
    <div
      key={product._id}
      className="flex flex-col  lg:col-span-3 cursor-pointer  items-center sm:flex-row py-8 px-2  pr-4 "
    >
      <div className=" my-24 h-32 w-72 md:h-40 md:w-40 flex-shrink-0  sm:my-8">
