...
function Products({ product }) {
  ...
  return (
    <>
      <div
        key={product._id}
        className="flex flex-col  justify-center align-middle     items-center sm:flex-col py-8 px-16 sm:px-4 md:px-8   "
      >
        <div
          onClick={() => router.push(`/product/${product._id}`)}
          className="mt-2 h-40 w-64 sm:w-52 sm:h-28 cursor-pointer md:h-48 md:w-80  sm:my-4"
        >
          <Image
            height={260}
            width={440}
