...
function Products({ product }) {
  ...
  return (
    <div
      key={product._id}
      className="flex flex-col my-24 overflow-x-scroll lg:col-span-6  cursor-pointer  items-center sm:flex-row py-7 px-[10rem] border-b pr-4    first:border-t"
    >
      <div className="  h-32 w-72 md:h-52 md:w-80 flex-shrink-0  sm:my-8">
      ...
      <div className="flex flex-row flex-grow mt-2 pl-5">
