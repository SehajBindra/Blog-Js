            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:py-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
              <div>
                ...
                >
                  {({ open }) => (
                    <>
                      <Listbox.Button className=" text-center bg-gray-100 rounded-md py-2 px-4 flex flex-row items-center space-x-2 justify-center align-middle mx-auto text-gray-400 ">
                      ...
                      <Transition
                        ...
                        leaveTo="opacity-0"
                      >
                        <Listbox.Options className="bg-gray-100 rounded-md py-2 px-4 my-2">
                          {people.map((person) => (
                            <Listbox.Option
                              key={person.id}
                              value={person}
