...
function Post({ post }) {
  ...
  return (
    <div className="bg-black mt-1 max-w-xs tracking-normal leading-relaxed sm:max-w-xl md:max-w-2xl xl:max-w-3xl scrollbar-hide overflow-x-hidden overflow-y-visible sm:overflow-visible  sm:overflow-x-hidden   text-white">
