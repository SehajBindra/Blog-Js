...
function ProductSection({ product }) {
  ...
  return (
    ...
    >
      <div className=" my-4 max-w-4xl  flex-shrink-0  sm:my-8">
      ...
      <div className="flex flex-col  pl-2">
        <h4 className="text-base max-w-xs sm:text-lg  font-semibold  sm:max-w-xl line-clamp-2  mt-2 text-left sm:text-left">
          {product.title}{" "}
        </h4>
