  ...
  return (
    <div className="top-0 sticky z-50 flex h-20  justify-between bg-white  overflow-x-hidden py-4 text-black shadow-xl ">
      ...
      <div className="flex  items-center space-x-2">
        <div className="bg-gray-100 rounded-lg flex-row">
          <input
            className="flex-row bg-transparent rounded-full px-4 py-4"
            type="text"
            placeholder="Search your blog.."
          />
          <MagnifyingGlassIcon className="h-8 flex flex-row items-center  text-black" />
        </div>
      </div>
