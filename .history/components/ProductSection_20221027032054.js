    ...
    >
      <div className=" my-4   sm:my-8">
        <Link href={`/product/${product._id}`}>
          <img
            className="rounded-md h-[8rem]    w-[8rem] sm:w-[10rem] sm:h-[10rem] hover:opacity-80 hover:shadow-lg  transition duration-200 ease-out  cursor-pointer object-contain  flex-shrink-0 "
            src={product.img}
          />
        </Link>
      </div>
