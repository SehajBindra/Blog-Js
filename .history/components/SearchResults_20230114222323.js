...
function SearchResults({ searchResults }) {
  ...
  return (
    <div className=" bg-black    overflow-y-auto pb-8 scrollbar-hide py-2  p-4 text-white flex flex-col justify-center align-middle w-80 mx-auto rounded-md  z-10 fixed top-16">
