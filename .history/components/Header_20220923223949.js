...
function Header() {
  ...
  return (
    <div className="top-0 sticky z-50 flex h-20 shadow-xl justify-between bg-white  overflow-x-hidden py-4 text-gray-800 border-1 ">
      {/* left */}
      <div
        onClick={router.push("/")}
        className="hidden sm:inline-flex items-center "
      >
        <p className="text-xl cursor-pointer py-2 px-4"> BLOG.JS</p>
      ...
      <div className=" flex items-center mx-4 cursor-pointer">
        <div className="flex items-center space-x-2  whitespace-nowrap ">
          <img
            ...
            alt=""
          />
          <p className="text-sm sm:text-base truncate text-gray-800">
