...
function Header() {
  ...
  return (
    <div className="top-0 sticky z-50 flex h-20  justify-between bg-gray-100  overflow-x-hidden py-4 text-black shadow-xl ">
      {/* left */}
      ...
      {/* center */}
      <div className=" text-sm flex cursor-pointer items-center space-x-2 ">
        <p onClick={() => Setopen(true)}>New Post</p>
