...
function SearchResults({ searchResults }) {
  ...
  return (
    <div className=" bg-black   overflow-y-scroll    p-4 text-white flex flex-col justify-center align-middle w-80 mx-auto rounded-md  z-10 fixed top-20 scrollbar-thumb-rounded-lg">
