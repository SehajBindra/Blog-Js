    ...
    <div className=" my-7  rounded-sm">
      ...
      <div className="flex items-center mr-12 p-5 ">
        ...
        <Menu as="div">
          {({ open }) => (
            <>
              <Menu.Button className=" text-red-400">More</Menu.Button>
              ...
              */}
                    <Menu.Items
                      className="flex flex-col flex-grow-0 w-32 sm:w-56 h-28 py-2 px-4  my-1 bg-white shadow-xl rounded-md border border-b "
                      as="div"
                    >
                      <Menu.Item>
                        {({ active }) => (
                            ...
                            <a
                              className={`${
                                active
                                  ...
                                  : "bg-white text-black rounded-md py-2 px-4 cursor-pointer"
                              }`}
                          ...
                          <a
                            className={`${
                              active
                                ...
                                : "bg-white border-b w-full text-black rounded-md py-2 px-4 cursor-pointer"
                            }`}
                            // href="/account-settings"
                          >
                            Delete
