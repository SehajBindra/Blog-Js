...
function SearchResults({ searchResults }) {
  ...
  return (
    <div className=" bg-black    overflow-y-scroll scrollbar-hide py-2  m-4 text-white flex flex-col justify-center align-middle w-80 mx-auto rounded-md  z-50 fixed top-16">
