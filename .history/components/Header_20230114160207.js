      ...
      <div className=" flex-grow sm:flex-grow-0 ml-2 pb-10 ">
        <div className=" relative  rounded-md ">
          <form
            className={
              !session
                ? "flex border-2 border-gray-800 xl:ml-64 lg:ml-56  rounded-full px-1 py-2 ml-2 mr-2 shadow-lg items-center"
                : "flex border-2 border-gray-800 sm:mr-20  rounded-full px-1 py-2 ml-2 mr-2 shadow-lg items-center"
            }
          >
            <input
