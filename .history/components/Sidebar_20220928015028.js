...
function Sidebar() {
  ...
  return (
    <div className="border-x col-span-1 sm:col-span-2 items-center  md:col-span-2 lg:col-span-2 md:items-start   sm:inline-flex flex-col">
      <img
        className=" mx-4 sm:inline-flex h-20 w-20 object cover"
