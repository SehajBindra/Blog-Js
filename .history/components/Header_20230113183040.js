...
function Header() {
  ...
  return (
    <div className="top-0 sticky z-50 flex sm:grid sm:grid-cols-3  text-center align-middle  h-20  justify-between bg-black overflow-y-auto    py-4 text-white border-1 ">
      {/* left */}
