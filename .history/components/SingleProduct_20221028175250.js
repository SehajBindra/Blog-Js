          ...
          {({ open }) => (
            <>
              ...
              <Transition
                ...
                leaveTo="opacity-0"
              >
                <Listbox.Options className="bg-gray-100 rounded-md py-1 px-4 my-2 h-32 overflow-y-scroll scrollbar-thin  scrollbar-thumb-gray-400 scrollbar-thumb-rounded-lg scrollbar-track-gray-100">
                  {people.map((person) => (
                    <Listbox.Option
                      key={person.id}
                      value={person}
