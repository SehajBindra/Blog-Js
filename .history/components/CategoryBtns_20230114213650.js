...
function CategoryBtns() {
  ...
  return (
    <>
      <div className="w-full max-w-lg px-4 py-2 sm:px-0">
        <Tab.Group defaultIndex={router.query.name === "Programing" ? 0 : 1}>
          <Tab.List className="flex flex-row  items-center overflow-x-scroll scrollbar-hide whitespace-nowrap justify-center space-x-4 rounded-md max-w-sm bg-black  p-1">
