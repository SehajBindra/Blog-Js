...
function Post({ product }) {
  ...
  return (
    <div className="mt-1 max-w-xl tracking-normal leading-relaxed sm:max-w-xl md:max-w-2xl xl:w-5xl scrollbar-hide overflow-x-hidden sm:overflow-visible    text-white">
      {/* header */}
      ...
      <div className="flex items-center mr-12 p-5 ">
        ...
        <div className=" ml-8 flex justify-between items-center mx-auto">
