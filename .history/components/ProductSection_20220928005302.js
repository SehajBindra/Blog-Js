...
function ProductSection({ product }) {
  ...
  return (
    ...
    >
      <div className=" my-20 w-[20rem]    sm:my-8">
        <Link href={`/product/${product._id}`}>
          <img
            className="rounded-md hover:opacity-80 hover:shadow-lg w-[20rem] transition duration-200 ease-out  cursor-pointer object-cover flex-shrink-0"
            src={product.img}
          />
        </Link>
      </div>
