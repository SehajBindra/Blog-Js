...
function Header() {
  ...
  return (
    <div className="top-0 sticky z-50 flex  h-20  justify-between bg-black  border-b border-gray-800  py-4 text-white border-1 ">
      ...
      <div className=" md:hidden  fixed left-0 bottom-0">
        <div className="flex bg-black  w-full h-24 overflow-x-scroll text-white  flex-row items-center justify-between">
          <ul className=" list-none text-sm flex">
            <li> Heloo</li>
            <li> Heloo</li>
            <li> Heloo</li>
          </ul>
