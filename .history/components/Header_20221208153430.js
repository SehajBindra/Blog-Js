  ...
  return (
    <div className="top-0 sticky z-50 flex  h-20  justify-between bg-black overflow-y-auto  border-b border-gray-800  py-4 text-white border-1 ">
      ...
      <div className=" flex-grow sm:flex-grow-0 ml-2 ">
        ...
        <div className="flex flex-col justify-center align-middle bg-black max-h-40 rounded-md text-white z-50">
          {data.map((data) => (
            <SearchResults key={data._id} searchResults={searchResults} />
          ))}
        </div>
      </div>
