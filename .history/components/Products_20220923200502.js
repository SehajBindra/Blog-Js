...
function Products({ product }) {
  ...
  return (
    <div
      key={product._id}
      className="flex flex-col lg:grid lg:grid-cols-4  cursor-pointer  items-center sm:flex-row py-7 px-2 border-b pr-4 rounded-xl  hover:opacity-80 hover:shadow-lg transition duration-200 ease-out first:border-t"
    >
