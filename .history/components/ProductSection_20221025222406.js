  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-grow  pl-2">
        <h4 className="text-base max-w-2xl line-clamp-1 flex-grow mt-2 text-left sm:text-left">
          {product.title}{" "}
        </h4>

        {/* <div className="border-b w-10 pt-2" /> */}

        <div className="text-xs max-w-2xl text-gray-500 flex-grow line-clamp-2 sm:text-base">
          {" "}
          {Parser(`${product.desc}`)}{" "}
        </div>
