      ...
      <div className="flex flex-row justify-between items-center">
        {updateMode && (
          <div onClick={() => handleupdate(post._id)}>
            <button className="text-sm font-semibold cursor-pointer my-4 mx-auto  justify-items-center   py-2 px-10 flex flex-col  align-middle rounded-lg bg-green-500 text-white">
              {" "}
              Publish{" "}
            </button>
          </div>
