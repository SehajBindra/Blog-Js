...
function ProductSection({ product }) {
  ...
  return (
    ...
    >
      <div className=" my-4 flex-shrink   sm:my-8">
        <Link href={`/product/${product._id}`}>
          <img
            className="rounded-md h-[10rem]  mx-auto  w-[15rem] hover:opacity-80 hover:shadow-lg  transition duration-200 ease-out  cursor-pointer object-cover  flex-shrink-0 "
            src={product.img}
          />
        </Link>
      </div>
