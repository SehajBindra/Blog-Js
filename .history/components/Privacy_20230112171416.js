    ...
    <div>
      <div className="max-w-4xl flex flex-col items-center mx-auto space-y-5  px-12 py-4 align-middle justify-center ">
        <div className="space-y-5 break-all">
          ...
          <h3 className="h2pp">Usage Data</h3>
          ...
          <h3 className="h2pp">Tracking Technologies and Cookies</h3>
          <p>
          ...
          <h2 className="h2pp">Use of Your Personal Data</h2>
          ...
          <h2 className="h2pp">Retention of Your Personal Data</h2>
          <p>
          ...
          <h2 className="h2pp">Transfer of Your Personal Data</h2>
          <p>
          ...
          <h2 className="h2pp">Delete Your Personal Data</h2>
          <p>
          ...
          <h2 className="h2pp">Disclosure of Your Personal Data</h2>
          ...
          <h2 className="h2pp">Security of Your Personal Data</h2>
          <p>
          ...
          <h1 className="h2pp">Children's Privacy</h1>
          <p>
          ...
          <h1 className="h2pp">Links to Other Websites</h1>
          <p>
