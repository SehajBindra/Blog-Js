      ...
      <div className="flex flex-row justify-between items-center">
        {updateMode && (
          <div onClick={() => handleupdate(post._id)}>
            <button className="text-sm font-semibold cursor-pointer my-4 mx-auto  justify-items-center shadow-xl  py-2 px-10 flex flex-col  align-middle rounded-lg bg-[#E23E57] text-white">
              {" "}
              Publish{" "}
            </button>
          </div>
