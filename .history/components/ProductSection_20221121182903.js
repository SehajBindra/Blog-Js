  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col  pl-2">
        <h4 className="text-base max-w-xs sm:text-lg   font-semibold sm:max-w-lg  line-clamp-1 ">
          {product.title}{" "}
        </h4>

        {/* <div className="border-b w-10 pt-2" /> */}

        <div className="text-xs max-w-xs    sm:max-w-lg text-gray-500  line-clamp-1 sm:text-base">
          {" "}
          {Parser(`${product.desc}`)}{" "}
        </div>
