    ...
    <div className="grid cursor-pointer  grid-cols-1 md:grid md:grid-cols-3 gap-y-10 px-40 py-14 pb-20 bg-black text-white">
      <div className="space-y-4 text-xs text-white">
        ...
        >
          <div className="navbar">
            <Image
              src="https://img.freepik.com/free-psd/3d-square-with-instagram-logo_125540-1566.jpg?w=740&t=st=1673617067~exp=1673617667~hmac=b27143522c6e0046ef3e3d0a5ef8089764fe7f96e0dca9af0eee75241613d50c"
              height={32}
              width={32}
