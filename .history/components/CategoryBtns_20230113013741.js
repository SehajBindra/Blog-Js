    ...
    <>
      <div className="w-full max-w-sm px-1 py-2 sm:px-0">
        <Tab.Group defaultIndex={router.query.name === "Programing" ? 0 : 1}>
          <Tab.List className="flex flex-row overflow-x-scroll scrollbar-hide whitespace-nowrap sm:grid-cols-2 sm:gap-4 justify-center rounded-md   max-w-xs bg-black  space-x-1 ">
