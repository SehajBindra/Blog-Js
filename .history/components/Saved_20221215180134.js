...
function Saved({ id, username, userImg, img, title }) {
  return (
    <div className="flex bg-black text-white h-full  flex-col  overflow-y-auto scrollbar-hide sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4">
