      ...
      <div className="flex items-center mr-12 p-5 ">
        ...
        {session && (
          <Menu className="relative" as="div">
            <>
              <div>
                <Menu.Button className="flex flex-row items-center text-gray-800">
      ...
      {session && (
        <form className="flex items-center p-4">
          <input
            ...
            className="border border-gray-800 bg-transparent rounded-full px-4 py-2 ml-2 flex-1 focus:ring-0 outline-none"
          />
          <button
            type="submit"
