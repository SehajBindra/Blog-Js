    ...
    <div className="top-0 sticky z-50 flex  h-20  justify-between bg-black  border-b border-gray-800  py-4 text-white border-1 ">
      ...
      {session && (
        <div className=" md:hidden  w-full  fixed left-0 bottom-0">
          <div className="flex bg-black h-16 rounded-t-md  text-white  flex-row items-center justify-between sm:justify-between sm:align-middle sm:px-8">
            <ul className=" list-none text-sm flex justify-between space-x-4 py-2 px-4">
              <div
                onClick={() => router.push("/")}
