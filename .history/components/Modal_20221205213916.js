                          ...
                          <Listbox.Options className="bg-gray-100 rounded-md py-1 px-4 my-2 max-h-[4.4rem] overflow-y-scroll scrollbar-hide">
                            {people.map((person, i) => (
                              <Listbox.Option
                                key={i}
                                value={person}
                                className="active:bg-black  my-2 rounded-sm  transition-all   flex flex-col justify-center align-middle mx-auto duration-200 active:text-black active:rounded-md  text-black"
                              >
