...
function Footer() {
  ...
  return (
    <div className="flex flex-col spac-y-5 justify-center align-middle cursor-pointer gap-x-8 whitespace-nowrap  md:grid md:grid-cols-3 gap-y-10 mx-auto sm:mx-auto py-14 pb-28 bg-black text-white">
