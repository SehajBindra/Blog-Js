...
function SearchResults({ searchResults }) {
  ...
  return (
    <div className=" bg-black h-56  h-screen  overflow-y-auto  scrollbar-thin scrollbar-thumb-[#ff2369] py-2  p-4 text-white flex flex-col justify-center align-middle w-80 mx-auto rounded-md  z-10 fixed top-16">
