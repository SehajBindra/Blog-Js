...
function Sidebar() {
  ...
  return (
    <div className=" hidden  col-span-1 items-center px-4 md:col-span-2 lg:col-span-2 md:items-start   sm:inline-flex flex-col">
      <img
      ...
      <SidebarRow
        onclick={currentUser ? dispatch(logout()) : dispatch(loginSuccess)}
        Icon={UserIcon}
