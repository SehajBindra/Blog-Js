            ...
            <div className=" inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:py-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
              <div>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  <Dialog.Title
                    as="h3"
                    className="text-lg leading-6 border py-4 px-2 border-1 font-medium text-gray-900"
                  >
                    Create a Post
                  </Dialog.Title>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="  focus:ring-0 border-b my-4 border-1 focus-within:outline-none w-full text-center"
                      type="text"
                      placeholder="Title"
                      //   ref={captionRef}
                    />
                  ...
                  <div className="mt-2">
                    <textarea
                      value={desc}
                      placeholder={`what would you like to say ${currentUser.data.data.username}`}
                      onChange={(e) => setDesc(e.target.value)}
                      className=" resize-none  focus-within:outline-none  w-full border-1 border-b bg-transparent"
                      rows="4"
                    ></textarea>
                    {/* <input
