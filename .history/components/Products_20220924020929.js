...
function Products({ product }) {
  ...
  return (
    <div
      key={product._id}
      className="flex flex-col   lg:col-span-6  cursor-pointer  items-center sm:flex-row py-7 px-2 border-b pr-4 "
    >
      <div className="flex flex-col  h-32 w-72 md:h-52 md:w-80 flex-shrink-0  sm:my-8">
