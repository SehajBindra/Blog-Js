  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col  pl-2">
        <h4 className="text-base max-w-xs sm:text-lg sm:line-clamp-1  font-semibold sm:max-w-lg  line-clamp-2  my-2 ">
          {product.title}{" "}
        </h4>

        {/* <div className="border-b w-10 pt-2" /> */}

        <div className="text-xs max-w-xs my-2   sm:max-w-lg text-gray-500  line-clamp-2 sm:text-base">
          {" "}
          {Parser(`${product.desc}`)}{" "}
        </div>
