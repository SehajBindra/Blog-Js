    ...
    <div className="md:inline  md:col-span-2 p-4     hidden ">
      ...
      <div className="">
        <div className=" my-8 text-base font-bold text-[#959595] text-opacity-[95%] gap-2  text-ellipsis grid grid-cols-3">
          <p className=" underline decoration-text-gray-400">About us</p>
          <p className="underline decoration-text-gray-400 col-span-2">Terms & Conditions</p>
          <p className="underline decoration-text-gray-400 whitespace-nowrap">Privacy policy</p>
        </div>
      </div>
    </div>
  );
