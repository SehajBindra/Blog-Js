...
function ProductSection({ product }) {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      key={product._id}
      className="flex flex-row max-w-4xl mx-auto  justify-center align-middle cursor-pointer  items-center sm:flex-row py-8 px-8  pr-2 "
    >
      ...
      <div className="flex flex-col  pl-2">
        <h4 className="text-base max-w-xs sm:text-lg  font-semibold  sm:max-w-xl line-clamp-1  mt-2 text-left sm:text-left">
          {product.title}{" "}
        </h4>
