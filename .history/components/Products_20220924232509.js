...
function Products({ product }) {
  ...
  return (
    <div
      key={product._id}
      className="flex flex-col  justify-center  flex-shrink-0   cursor-pointer  items-center sm:flex-row py-8 px-2  pr-4 "
    >
      <div className=" my-20 h-32 w-72 md:h-40 md:w-80  flex-shrink-0 mx-auto  sm:my-8">
