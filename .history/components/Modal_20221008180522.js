  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog
        ...
        onClose={Setopen}
      >
        <div className=" flex items-end justify-center min-w-[400px] min-h-[700px] sm:min-h-screen pt-4 px-8 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            as={Fragment}
                  ...
                  {({ open }) => (
                    <>
                      ...
                      <Transition
                        ...
                        leaveTo="opacity-0"
                      >
                        <Listbox.Options className="bg-gray-100 rounded-md py-1 px-4 my-2 max-h-16 overflow-y-scroll scrollbar-hide">
                          {people.map((person) => (
                            <Listbox.Option
                              key={person.id}
                              value={person}
