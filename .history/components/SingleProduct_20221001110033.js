        ...
        {({ open }) => (
          <>
            ...
            >
              ...
              */}
                  <Menu.Items
                    className="flex flex-col justify-center items-center align-middle py-2 px-4 my-1 bg-gray-100 rounded-md cursor-pointer"
                    as="div"
                  >
                    <Menu.Item>
                      {({ active }) => (
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <a
                          className={`${
                            active &&
                            "bg-black rounded-md text-white py-2 px-4 mx-auto cursor-pointer"
                          }`}
                          // href="/account-settings"
                        >
                          Delete
