                        ...
                        <Listbox.Options>
                          {people.map((person) => (
                            <Listbox.Option
                              key={person.id}
                              value={person}
                              className="active:bg-gray-100  my-2 transition-all  text-center flex flex-col justify-center align-middle mx-auto duration-200 active:text-black active:rounded-md bg-white text-black"
                            >
