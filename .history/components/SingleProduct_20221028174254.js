    ...
    <div className="mt-1 max-w-xs sm:max-w-xl md:max-w-2xl xl:w-5xl scrollbar-hide overflow-x-hidden sm:overflow-visible    text-white">
      ...
      {updateMode && (
        ...
        >
          {({ open }) => (
            <>
              <Listbox.Button className=" text-center bg-gray-100 text-black rounded-md py-2 px-4 flex flex-row items-center space-x-2 justify-center align-middle mx-auto  ">
