...
function Sidebar() {
  ...
  return (
    <div className="border-r fixed  left-10 right-0  top-20 z-50 bg-black border-gray-800 hidden sm:col-span-1 items-center px-4 md:col-span-2 lg:col-span-2 md:items-start   sm:inline-flex flex-col">
      <img
